...
<body>
    <%
        ...
        // Get completed reservations without reviews
    ...
    <div class="main-container animated">
        ...
        <!-- Reservations to Review Section -->
        ...
        <% if (userReviews != null && !userReviews.isEmpty()) { %>
            <%
            // DateTimeFormatter for formatting the dates
            ...
            for (Review review : userReviews) {
                ...
                // Display updated time if different from created time
