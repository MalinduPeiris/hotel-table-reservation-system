...
<body>
    <%
        ...
        // Get reservation and menu data from attributes
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Event delegation for remove buttons (including dynamically added items)
            ...
            function addMenuItem(itemId, itemName, itemPrice, quantity) {
                // First, check if this item is already selected
            ...
            function removeMenuItemFromServer(itemId) {
                // Create XHR request to remove menu item
                const xhr = new XMLHttpRequest();
