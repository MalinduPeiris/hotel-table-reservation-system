...
<%
    ...
    // Create maps for user and reservation lookups
    Map<String, User> userCache = new HashMap<>();
    Map<String, Reservation> reservationCache = new HashMap<>();

    // Initialize the formatter for dates
    ...
    <table class="data-table">
        ...
        <tbody>
            <% for (Review review : allReviews) {
                ...
                // Get reservation from cache or database
                ...
                // Format table info if available
                String tableInfo = "";
                ...
                String ratingColor = "#4CAF50"; // Green for good ratings
                if (review.getRating() <= 2) {
                    ratingColor = "#F44336"; // Red for bad ratings
                } else if (review.getRating() == 3) {
                    ratingColor = "#FFC107"; // Yellow for average
                }
            %>
            <tr>
